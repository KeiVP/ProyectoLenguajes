...
namespace Models
{
    public partial class VentaRopaContext : DbContext
    {
        ...
        public virtual DbSet<Direccion> Direcciones { get; set; } // Agregar DbSet<Direccion>
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // Configuración para la nueva entidad Direccion
            modelBuilder.Entity<Direccion>(entity =>
            {
                entity.HasKey(e => e.DireccionId).HasName("PK__DIRECCION__0FF9A0BBA66D3ABA");
                ...
                entity.HasOne(d => d.ClienteID).WithMany(p => p.Direcciones)
                    .HasForeignKey(d => d.ClienteID)
                    .HasConstraintName("FK__DIRECCION__clienteID__46E78A0C");
            });
